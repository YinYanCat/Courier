...
SECRET_KEY = 'django-insecure-*l+=isoqfpl!u5$6g9g_1*kemitu3o*4nho-9c3$!n*^#ijs3w'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'options': '-c search_path=courier,public',  # Esto asegura que las tablas se creen en tu esquema
        }
    }
}
